...
class BST:
    ...
    def delete(self, data):
        ...
        if current.get_left() is None:
            ...
            succes = current.get_left()
            succes_parent = current

            while succes.get_right() is not None:
                succes_parent = succes
                succes = succes.get_right()

            current.set_data(succes.get_data())

            if succes_parent.get_left() == succes:
                succes_parent.set_left(succes.get_left())
            else:
                succes_parent.set_right(succes.get_left())
